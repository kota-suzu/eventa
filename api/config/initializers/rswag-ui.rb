Rswag::Ui.configure do |c|
  ...
  # Swagger UIのホスティングパス
  c.swagger_endpoint '/api-docs/v1/swagger.yaml', 'eventa API V1 Documentation'

  # ドキュメントのタイトル設定
  # 注: swagger_ui_titleは非推奨になりました
  # タイトルはswagger_endpointの第2引数で指定するか、直接YAMLファイルで設定します

  # バージョン選択機能（複数のバージョンがある場合）
  # c.swagger_endpoint '/api-docs/v2/swagger.yaml', 'API V2 Documentation'
